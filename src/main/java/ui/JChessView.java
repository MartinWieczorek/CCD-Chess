...
public class JChessView extends FrameView implements ActionListener, ComponentListener
{
    ...
    private void initComponents() {
        ...
        gamesPane = new ui.JChessTabbedPane();
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(core.JChessApp.class).getContext().getResourceMap(JChessView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(core.JChessApp.class).getContext().getActionMap(JChessView.class, this);

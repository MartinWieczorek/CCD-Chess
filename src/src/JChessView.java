...
public class JChessView extends FrameView implements ActionListener, ComponentListener
{
    ...
    private void initComponents() {
        ...
        gamesPane = new src.JChessTabbedPane();
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(src.JChessApp.class).getContext().getResourceMap(JChessView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(src.JChessApp.class).getContext().getActionMap(JChessView.class, this);
